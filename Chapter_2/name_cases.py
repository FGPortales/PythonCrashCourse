...
print("Hello {}, would you like to learn\
    some python today?".format(name_person))
...
name_famous = 'Steve Jobs'
quote = '“I’m as proud of many of the things we haven’t done as the things we\
    have done.”'
print("{} once said, {}".format(name_famous, quote))
